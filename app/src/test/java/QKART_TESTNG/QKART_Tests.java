...
public class QKART_Tests {
     ...
     * expected
     */
    @Test(description = "Verify the existence of size chart for certain items and validate contents of size chart", priority = 4, 
        groups = {"Regression_Test" } , dataProvider = "data-provider" , dataProviderClass = DP.class   )
     ...
     * working correctly
     */
    @Test(description = "Verify that a new user can add multiple products in to the cart and Checkout", priority = 5, 
        groups = {"Sanity_test" }, dataProvider = "data-provider" , dataProviderClass = DP.class  )
     ...
     */
    @Test(description = "Verify that the contents made to the cart are saved against the user's login details", priority = 7, 
        groups = {"Regression_Test" } , dataProvider = "data-provider", dataProviderClass = DP.class  )
    ...
    public void TestCase07(String TC7_ListOfProductsToAddToCart) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[contains(@class,'zgtx0t')]")));
     ...
     * wallet balance
     */
    @Test(description = "Verify that insufficient balance error is thrown when the wallet balance is not enough", priority = 8, 
        groups = {"Sanity_test" } , dataProvider = "data-provider", dataProviderClass = DP.class   )
     ...
     */
    @Test(description = "Verify that a product added to a cart is available when a new tab is added", priority = 10, 
        dependsOnMethods = {"TestCase10" }, groups = { "Regression_Test" })
     ...
     */
    @Test(description = "Verify that privacy policy and about us links are working fine", priority = 9, 
     ...
     */
    @Test(description = "Ensure that the Advertisement Links on the QKART page are clickable", priority = 12, 
        groups = {"Sanity_test" }, dataProvider = "data-provider", dataProviderClass = DP.class   )

...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        // SLEEP_STMT_16: Wait for user name to be entered
        //Thread.sleep(1000);
        ...
        // Wait for Login action to complete
         // SLEEP_STMT_17: Wait for Login action to complete
        //Thread.sleep(5000);
        ...
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("username-text")));
